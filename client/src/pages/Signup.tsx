...
import { UserPlus, Mail, Lock, User as UserIcon, LayoutDashboard, Sun, Moon, Home } from 'lucide-react';
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <p style={styles.subtitle}>Join FocusFlowAI and unlock AI-driven productivity insights</p>
        </div>
